...
<section class="hero">
  <div class="hero-content">
    <div class="hero-image">
      <img src="/images/head.png" alt="Learning Illustration" />
    </div>
    <div class="hero-text">
...
<section className="why-best">
  ...
  <p className="section-description">
    Discover what makes us stand out from the rest. Here’s why we are the preferred choice for learners worldwide.
  </p>
  ...
  <div className="features-grid">
    <div className="feature-card">
      ...
      <h4>Top-Quality Education</h4>
      <p>
        Our courses are designed and delivered by industry experts to provide you with the best learning experience.
      </p>
    
    </div>
    <div className="feature-card">
      <img src="images/flexible.png" alt="Flexible Learning" className="feature-image" />
      <h4>Flexible Learning</h4>
      <p>
        Learn at your own pace, anywhere and anytime, with our self-paced courses and flexible schedules.
      </p>
    </div>
    <div className="feature-card">
      <img src="images/expert.jpg" alt="Expert Support" className="feature-image" />
      <h4>Doubt Clearance Session</h4>
<p>
  Get personalized doubt clearance sessions with our experienced tutors, available to help you with any queries and challenges.
</p>

    </div>
    <div className="feature-card">
      <img src="images/certification.png" alt="Certification" className="feature-image" />
      <h4>Recognized Certifications</h4>
      <p>
        Earn industry-recognized certifications to boost your resume and stand out in your career.
      </p>
    </div>
  </div>
</section>
